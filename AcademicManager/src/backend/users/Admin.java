...
public class Admin extends User {
	 ...
	 * @param rut The unique role identifier of the Admin.
	 * @param name The name of the Admin.
	 * @param lastnameF The last name from the father of the Admin.
	 * @param lastnameM The last name from the mother of the Admin.
	 * @param address The address of the Admin.
	 * @param gender The gender of the Admin.
	 * @param access The access of the Admin.

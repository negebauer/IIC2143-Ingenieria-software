...
public class EvaluationsReaderWriter {
	...
	/* File format
	course initials&course evaluation&classroom initials&date string
	*/
	...
	/**
	 * Reads all the course evaluations from the .txt file and adds them to each corresponding course.

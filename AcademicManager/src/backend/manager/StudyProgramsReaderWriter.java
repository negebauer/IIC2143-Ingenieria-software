...
public class StudyProgramsReaderWriter {
	...
	*/
	 ...
	 * @param allStudyPrograms All the studyPrograms to save.
	 */
	public static void writeStudyPrograms(ArrayList<StudyProgram> allStudyPrograms) {
		try {
			...
			for (StudyProgram studyProgram : allStudyPrograms) {
				...
				FileOutputStream fileOutputStream = new FileOutputStream (studyProgramFolder.getCanonicalPath() + FolderFileManager.adminStudyProgramInfo);

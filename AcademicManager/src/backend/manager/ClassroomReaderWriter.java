...
/**
 * Class that manages the reading and writing of all the classrooms from the 'database'.
 */
public class ClassroomReaderWriter {

	/* File format
		initials&school&campus&size
	*/

	/**
	 * Writes all the classrooms to the classrooms.txt file.
	 * @param classrooms The classrooms to be written.
	 */
	...
	/**
	 * Reads all the classrooms from the classrooms.txt file and returns them in a list.

...
public class Curriculum {
	 ...
	 * 
	 * @param program
	 *            An ArrayList containing the study programs that the student is
	 *            coursing in the University.
	 */
	 ...
	 * 
	 * @param studyProgram
	 *            The study program you want to see it's curricular advance.
	...
	public ArrayList<CoursedSemester> getCoursedSemesters() {
		...
		for (Coursed coursedCourse : coursedCourses) {
			...
			for (CoursedSemester coursedSemester : coursedSemesters) {
				if (coursedSemester.getYear() == coursedCourse.getYear()
						&& coursedCourse.getSemester() == coursedSemester.getSemester()) {
	...
	public class ApprovedUnapprovedCoursesTuple {
		 ...
		 * 
		 * @param approvedCourses
		 *            The ArrayList that contains all the Coursed courses that
		 *            have been approved.
		 * @param unapprovedCourses
		 *            The ArrayList that contains all the courses that haven't
		 *            been approved yet.
		 */
	 ...
	 * 
	 * @param program
	 *            The study program to be removed.
	 */

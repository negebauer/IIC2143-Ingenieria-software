...
/**
 * Protocol used to define a class as an ICourse, which represents an actual
 * (physical) class that is made in a classroom in a certain schedule.
 */

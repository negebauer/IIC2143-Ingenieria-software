...
public interface IAssistants extends ICourse {
	 ...
	 * 
	 * @param assistant
	 *            The assistant to be added to this Assistantship
	 */
	 ...
	 * 
	 * @param assistant
	 *            The assistant to be removed from this Assistantship
	 */
	...
	/**
	 * Returns the assistant from the assistants list that corresponds to the
	 * given index
	 * 
	 * @param index
	 *            The index of the assistant to be returned
